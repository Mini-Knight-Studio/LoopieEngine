...
namespace Loopie
{
    public class BoxCollider : Component
    {
        ...
        private Vector3 GetLocalCenter()
        {
            ...
            InternalCalls.BoxCollider_GetLocalCenter(entity.ID, out center);
            return center;
        }

        private void SetLocalCenter(Vector3 center)
        {
            InternalCalls.BoxCollider_SetLocalCenter(entity.ID, center);
        }
        ...
        private Vector3 GetLocalExtents()
        {
            ...
            InternalCalls.BoxCollider_GetLocalExtents(entity.ID, out extents);
            return extents;
        }

        private void SetLocalExtents(Vector3 extents)
        {
            InternalCalls.BoxCollider_SetLocalExtents(entity.ID, extents);
        }
        ...
        {
            return InternalCalls.BoxCollider_IsColliding(entity.ID);
        }
        ...
        {
            return InternalCalls.BoxCollider_HasCollided(entity.ID);
        }
        ...
        {
            return InternalCalls.BoxCollider_HasEndedCollision(entity.ID);
        }
    }
}